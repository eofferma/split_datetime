...
describe SplitDatetime::Accessors do
  ...
  context "Testing accepts_split_time_for..." do
    ...
    describe "split time methods" do
      ...
      it "sets the hour in the starts_at method" do
        model.send("starts_at(4i)=", "23")
        model.starts_at.hour.should == 23
      end

      it "sets the minutes in the starts_at method" do
        model.send("starts_at(5i)=", "54")
        model.starts_at.min.should == 54
      end
  ...
  context "Testing accepts_split_datetime_for..." do
    before do
